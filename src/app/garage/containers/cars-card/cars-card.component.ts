  ...
  template: `
    <div class="cars-card">
      ...
      <div class="cars-card-track">
        <span class="cars-track-name"></span>
        <svg class="car"
          style="fill:red"
        ...
        <svg class="finish" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="-3.2 -3.2 36.40 28.40">
          <g id="SVGRepo_iconCarrier"> <polyline style="fill:none;stroke:#000000;stroke-width:2;stroke-miterlimit:10;" points="6,28 6,5 26,5 26,19 6,19 ">
          </polyline> <rect x="22" y="5" width="4" height="4">
        </rect> <rect x="19" y="15" width="3" height="4">
        </rect> <rect x="19" y="9" width="3" height="3">
        </rect> <rect x="13" y="15" width="3" height="4">
        </rect> <rect x="13" y="9" width="3" height="3">
        </rect> <rect x="6" y="15" width="4" height="4">
        </rect> <rect x="6" y="9" width="4" height="3">
        </rect> <rect x="22" y="12" width="4" height="3">
        </rect> <rect x="16" y="12" width="3" height="3">
        </rect> <rect x="10" y="12" width="3" height="3">
        </rect> <rect x="16" y="5" width="3" height="4">
        </rect> <rect x="10" y="5" width="3" height="4">
        </rect> </g>
        </svg>
      </div>
    </div>
